    ...
    <main className="absolute w-11/12 sm:w-8/12 lg:w-5/12 xl:w-4/12 left-1/2 top-[50vh] -translate-x-1/2 -translate-y-1/2 flex flex-col px-4 py-10">
      ...
      <section className="text-neutral-600 rounded-2xl text-center px-4 py-10 mt-4">
        ...
        <p className="text-sm sm:text-base pt-2">
          ...
          <span
            className="px-1 text-indigo-600 hover:text-indigo-400 cursor-pointer hover:underline"
            onClick={goBack}
          >
            previous page
          </span>
          ...
          <Link
            href="/"
            className="mx-1 text-indigo-600 hover:text-indigo-400 hover:underline"
          >
            home page
          </Link>
          .
