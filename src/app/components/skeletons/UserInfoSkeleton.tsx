...
function UserInfoSkeleton() {
    return (
        <>
            <section className="relative flex justify-center items-center flex-col w-full sm:w-10/12 md:w-2/3 xl:w-3/6 mx-auto px-4 xs:px-10 mt-16 pt-20 pb-4 bg-white dark:bg-[#344453] dark:text-slate-300 border-t sm:border dark:border-gray-600 sm:rounded-lg sm:shadow-md sm:shadow-slate-100 dark:shadow-none">
