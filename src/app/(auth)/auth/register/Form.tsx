        ...
        <>
            <Formik
                ...
                onSubmit={async (values) => {
                    ...
                    try {
                        const response = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/users/register/`, {
                            method: 'POST',
                ...
                {({ values, errors, touched, isValid, isSubmitting }) => (
                    ...
                    >
                        <div className="md:p-4">
                            ...
                            <div className={successMsg ? 'w-full alert alert-info p-4 my-4 rounded-sm text-center' : 'hidden'} aria-live="assertive">{successMsg}</div>
                            ...
                            <div className="py-6">
                                <button type="submit" disabled={!isValid || isSubmitting} className={'block px-8 w-full py-2 xs:w-max border-none shadow rounded-full font-semibold text-gray-50 hover:bg-indigo-500 bg-indigo-400 cursor-pointer disabled:opacity-60'}>
