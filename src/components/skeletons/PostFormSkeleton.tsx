...
function PostFormSkeleton() {
    return (
        <div className="relative w-full h-screen rounded-lg border-t border-b md:border bg-white dark:bg-slate-400 border-gray-200 dark:border-0 shadow-md shadow-slate-200 dark:shadow-none py-4 md:py-8 space-y-4 md:space-y-8">
